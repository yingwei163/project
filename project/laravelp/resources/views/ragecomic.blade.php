                    ...
                    @if($bimgxin)
                            @for($i=0;$i<count($bimgxin);$i++)
                                <div class="ganlist" id="bimg{{$bimgxin[$i]['id']}}">
                                    <div class="gantop">
                                        <div class="topc-left">
                                            <img class="img-circle" src="{{$bimgxin[$i]['usericon']}}" alt="zzz">
                                        </div>
                                        ...
                                        <div class="topc-right clearfix">
                                            <div class="install clearfix">
                                                ...
                                                <lu id="inright" class="inright user0">编辑频道
                                                    <input class="img-value" type="hidden" value="{{$bimgxin[$i]['id']}}">
                                    ...
                                    <div class="topc-bottom">
                                        ...
                                        <img class="pcimg" src="{{url($bimgxin[$i]['bimgx'])}}" alt="zzz">
                                    </div>
                                    <div class="reviewed">
                                        <ul class="pull-left">
                                            <li>
