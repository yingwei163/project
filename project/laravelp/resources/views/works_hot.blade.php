...
@section('mid')
    ...
    <div  id="midden">
        ...
        <div id="falls" class="container">
            ...
            @if(!($one==0 && $tow==0 && $three==0 && $tetra==0))
                {{--暴漫--}}
                    @if($one)
                        @for($i=0;$i<count($one);$i++)
                            <div class="ganlist" id="bimg{{$one[$i]['works_id']}}">
                                <div class="gantop">
                                    <div class="topc-left">
                                        <img class="img-circle" src="{{$one[$i]['usericon']}}" alt="zzz">
                                    </div>
                                    <div class="topc-center">
                                        <span class="center-ll">{{$one[$i]['username']}}</span>
                                        <span class="rorgin" style="font-size:12px;width:100%;text-align:center;">{{$one[$i]['bimgt']}}</span>
                                    </div>
                                ...
                                <div class="topc-bottom">
                                    <p class="topc-title">{{$one[$i]['bimgb']}}</p>
                                    <img class="pcimg" src="{{url($one[$i]['bimgx'])}}" alt="zzz">
                                </div>
                                <div class="reviewed">
                                    <ul class="pull-left">
                                        <li>
                                    ...
                                    <ul class="pull-right">
                                        <li>
                                            <input type="hidden" class="bimg" value="{{$one[$i]['works_id']}}">
                                            <span class="parise"><i class="glyphicon glyphicon-thumbs-up"></i><span>{{$one[$i]['praises']}}</span></span>
                                            <span class="solid"><i class="glyphicon glyphicon-thumbs-down"></i><span>{{$one[$i]['rottens']}}</span></span>
                                            <span class="message"><i class="glyphicon glyphicon-comment"></i><span>{{$one[$i]['talks']}}</span></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="message-content">
                                    ...
                                    <div class="cj_button">
                                        ...
                                        <div class="cj_bttp">
                                            <span>0/300</span>
                                            <input class="img" type="hidden" value="{{$one[$i]['works_id']}}">
                ...
                {{--趣图--}}
                    @if($tow)
                        @for($i=0;$i<count($tow);$i++)
                            <div class="ganlist" id="bimg{{$tow[$i]['works_id']}}">
                                <div class="gantop">
                                    <div class="topc-left">
                                        <img class="img-circle" src="{{$tow[$i]['usericon']}}" alt="zzz">
                                    </div>
                                    <div class="topc-center">
                                        <span class="center-ll">{{$tow[$i]['username']}}</span>
                                        <span class="rorgin" style="font-size:12px;width:100%;text-align:center;">{{$tow[$i]['imgt']}}</span>
                                ...
                                <div class="topc-bottom">
                                    <p class="topc-title">{{$tow[$i]['imgb']}}</p>
                                    <img class="pcimg" src="{{url($tow[$i]['imgx'])}}" alt="zzz">
                                </div>
                                <div class="reviewed">
                                    <ul class="pull-left">
                                        <li>
                                    ...
                                    <ul class="pull-right">
                                        <li>
                                            <input type="hidden" class="bimg" value="{{$tow[$i]['works_id']}}">
                                            <span class="parise"><i class="glyphicon glyphicon-thumbs-up"></i><span>{{$tow[$i]['praises']}}</span></span>
                                            <span class="solid"><i class="glyphicon glyphicon-thumbs-down"></i><span>{{$tow[$i]['rottens']}}</span></span>
                                            <span class="message"><i class="glyphicon glyphicon-comment"></i><span>{{$tow[$i]['talks']}}</span></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="message-header">
                                ...
                                <div class="message-content">
                                    ...
                                    <div class="cj_button">
                                        ...
                                        <div class="cj_bttp">
                                            <span>0/300</span>
                                            <input class="img" type="hidden" value="{{$tow[$i]['works_id']}}">
                                            <button class="cj_butt">发表</button>
                                        </div>
                                    </div>
                                </div>
