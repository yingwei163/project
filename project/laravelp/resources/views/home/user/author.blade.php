...
@section('topdenv')
    ...
    <div class="container top-nav">
        ...
        <div  class="top-right">
            @if(Auth::check())
                <a href="{{url("/home/user/c-index")}}"><div id='user' class="glyphicon glyphicon-user">{{Auth::user()->name}}</div></a>
    ...
    <!--中全部-->
        ...
        <div id="falls" class="container">
            ...
            <div class="falls-midden">
                ...
                @section('txt')
                    <div class="falls-midden-midd">
                        <div class="falls-midden-mid-titt">

                                @foreach($comment as $k)
                                    <div id="hui">
                                        <div id="huii">
                                            <div class="tit-left"> <img src="{{$k->icon}}" alt="..." class="img-circle" width="55" height="55"></div>
                                        <div class="falls-midden-mid-tit-bt"><div class="tit-left">{{$k->name}}</div></div>

                                        <form id="fgz">
                                                <div class="falls-midden-mid-tit-btt">

                                                    @if(empty(Auth::id()))<div class="tit-left jgz gz"><span class="glyphicon glyphicon-plus gg sb" id="gg ">关注</span></div>
                                                    @elseif(Auth::id())<div id="lid{{$k->userid}}" class="tit-left jgz gz sb" ><span class="glyphicon glyphicon-plus gg " id="gg{{$k->userid}}">关注</span></div>
                                                    @else
                                                        <div class="tit-left jgz gz sb" ><span class="glyphicon glyphicon-plus gg sb" id="gg" style="cursor: pointer;">关注</span></div>@endif


                                                    <input id='hj' type="text" name='zid' value="{{$k->userid}}"><input type="text" id='hj' value="{{$k->name}}">
