        ...
        <div id="falls" class="container">
            ...
            <div class="falls-midden">
                ...
                <div class="falls-midden-top">
                    <div class="falls-hot2"><a href="{{url('/home/user/works_hot')}}">热门<span class="glyphicon glyphicon-arrow-down"></span></a></div>
                    <div class="falls-hott2"><a href="">最新<span class="glyphicon glyphicon-arrow-down"></span></a></div>
                    <div id="falls-mi-nav">
                        <form class="navbar-form navbar-right" action="{{url('/home/user/nav')}}">
                            {{--<div class="form-group">--}}
                ...
                {{--暴漫--}}
                    @if($bimg)
                        @for($i=0;$i<count($bimg);$i++)
                            <div class="ganlist" id="bimg{{$bimg[$i]['id']}}">
                                <div class="gantop">
                                    <div class="topc-left">
                                        <img class="img-circle" src="{{$bimg[$i]['usericon']}}" alt="zzz">
                                    </div>
                                    <div class="topc-center">
                                        <span class="center-ll">{{$bimg[$i]['username']}}</span>
                                        <span class="rorgin" style="font-size:12px;width:100%;text-align:center;">{{$bimg[$i]['bimgt']}}</span>
                                    </div>
                                ...
                                <div class="topc-bottom">
                                    ...
                                    <img class="pcimg" src="{{url($bimg[$i]['bimgx'])}}" alt="zzz">
                                </div>
                                <div class="reviewed">
                                    <ul class="pull-left">
                                        <li>
                                    ...
                                    <ul class="pull-right">
                                        <li>
                                            <input type="hidden" class="bimg" value="{{$bimg[$i]['id']}}">
                                            <span class="parise"><i class="glyphicon glyphicon-thumbs-up"></i><span>{{$bimg[$i]['praises']}}</span></span>
                                            <span class="solid"><i class="glyphicon glyphicon-thumbs-down"></i><span>{{$bimg[$i]['rottens']}}</span></span>
                                            <span class="message"><i class="glyphicon glyphicon-comment"></i><span>{{$bimg[$i]['talks']}}</span></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="message-content">
                                    ...
                                    <div class="cj_button">
                                        ...
                                        <div class="cj_bttp">
                                            <span>0/300</span>
                                            <input class="img" type="hidden" value="{{$bimg[$i]['id']}}">
                ...
                {{--趣图--}}
                    @if($img)
                        @for($i=0;$i<count($img);$i++)
                            <div class="ganlist" id="bimg{{$img[$i]['id']}}">
                                <div class="gantop">
                                    <div class="topc-left">
                                        <img class="img-circle" src="{{$img[$i]['usericon']}}" alt="zzz">
                                    </div>
                                    <div class="topc-center">
                                        <span class="center-ll">{{$img[$i]['username']}}</span>
                                        <span class="rorgin" style="font-size:12px;width:100%;text-align:center;">{{$img[$i]['imgt']}}</span>
                                    </div>
                                    <div class="topc-right clearfix">
                                        <div class="install clearfix">
                                            <div class="inleft">频道</div>
                                ...
                                <div class="topc-bottom">
                                    ...
                                    <img class="pcimg" src="{{url($img[$i]['imgx'])}}" alt="zzz">
                                </div>
                                <div class="reviewed">
                                    <ul class="pull-left">
                                        <li>
                                    ...
                                    <ul class="pull-right">
                                        <li>
                                            <input type="hidden" class="bimg" value="{{$img[$i]['id']}}">
                                            <span class="parise"><i class="glyphicon glyphicon-thumbs-up"></i><span>{{$img[$i]['praises']}}</span></span>
                                            <span class="solid"><i class="glyphicon glyphicon-thumbs-down"></i><span>{{$img[$i]['rottens']}}</span></span>
                                            <span class="message"><i class="glyphicon glyphicon-comment"></i><span>{{$img[$i]['talks']}}</span></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="message-header">
                                ...
                                <div class="message-content">
                                    ...
                                    <div class="cj_button">
                                        ...
                                        <div class="cj_bttp">
                                            <span>0/300</span>
                                            <input class="img" type="hidden" value="{{$img[$i]['id']}}">
                                            <button class="cj_butt">发表</button>
                                        </div>
                                    </div>
                                </div>
